...
run: volimage.run
	./volimage.run brain_mri_raws/MRI -d 66 67 outputDiffMap
#	./volimage.run brain_mri_raws/MRI -x 66 outputExtractSlice
#	./volimage.run brain_mri_raws/MRI -g 6 outputExtractRow